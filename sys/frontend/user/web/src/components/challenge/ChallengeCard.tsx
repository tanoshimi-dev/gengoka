...
export function ChallengeCard({ item }: ChallengeCardProps) {
  ...
  return (
    <Link
      ...
      className="relative flex w-[40%] max-w-[200px] shrink-0 snap-start flex-col justify-between rounded-xl p-4 shadow-sm transition-transform hover:scale-[1.02] sm:w-[30%] lg:w-[200px]"
      style={{
