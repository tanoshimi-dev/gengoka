...
pub fn configure(cfg: &mut web::ServiceConfig) {
    cfg.service(
        web::scope("/api/v1")
            ...
            .route("/users/me/social-accounts", web::get().to(handlers::get_linked_accounts))
            .route("/users/me/social-accounts", web::post().to(handlers::link_account))
            .route("/users/me/social-accounts/{provider}", web::delete().to(handlers::unlink_account))
